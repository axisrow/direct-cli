...
# incremental split). The names below are re-imported so the CLI surface is
# byte-for-byte identical to the former monolith.
from ._campaigns_base import (
    ATTRIBUTION_MODELS,
    BLOCKED_IPS_MAX_ITEMS,
    CAMPAIGNS_GET_CRITERIA_LIMITS,
    CLIENT_INFO_MAX_LENGTH,
    EXCLUDED_SITE_MAX_LENGTH,
    EXCLUDED_SITES_MAX_ITEMS,
    NEGATIVE_KEYWORD_SHARED_SET_IDS_MAX_ITEMS,
    RELEVANT_KEYWORDS_MODES,
    VIDEO_TARGETS,
    YES_NO,
    _array_of_integer_option,
    _array_of_string_option,
    _build_dynamic_placement_types,
    _build_frequency_cap,
    _build_notification,
    _build_package_bidding_strategy,
    _build_relevant_keywords,
    _build_smart_package_bidding_strategy,
    _build_time_targeting,
    _deprecated_campaigns_structured_option,
    _parse_csv_option,
...
from ._campaigns_dynamic import build_add_block as _build_dynamic_add_block
from ._campaigns_text import build_add_block
from ._execute import execute_request
from ._lifecycle import register_lifecycle_commands
from . import _campaigns_unified as unified  # noqa: E402,F401
...
def add(
    ...
    if campaign_type_norm == "TEXT_CAMPAIGN":
        build_add_block(
            ...
            package_bidding_strategy_obj=package_bidding_strategy_obj,
            counter_ids_obj=counter_ids_obj,
            priority_goals_items=priority_goals_items,
            negative_keyword_shared_set_ids_obj=negative_keyword_shared_set_ids_obj,
            relevant_keywords_obj=relevant_keywords_obj,
            goal_id=goal_id,
            ...
            text_search_weekly_spend_limit=text_search_weekly_spend_limit,
            ...
            text_search_reserve_return=text_search_reserve_return,
            text_search_roi_coef=text_search_roi_coef,
            text_search_profitability=text_search_profitability,
            text_search_exploration_min_budget=text_search_exploration_min_budget,
            ...
            text_network_reserve_return=text_network_reserve_return,
            text_network_roi_coef=text_network_roi_coef,
            text_network_profitability=text_network_profitability,
            text_network_exploration_min_budget=text_network_exploration_min_budget,
            text_network_exploration_is_custom=text_network_exploration_is_custom,
            text_network_limit_percent=text_network_limit_percent,
            attribution_model=attribution_model,
            tracking_params=tracking_params,
        )
    elif campaign_type_norm == "UNIFIED_CAMPAIGN":
        unified.build_add_block(
            p,
            campaign_data,
            parsed_settings,
            counter_ids_obj,
