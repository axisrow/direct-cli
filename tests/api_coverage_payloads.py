...
PAYLOAD_CASES = [
    ...
    # --- issue #363: UnifiedCampaign.BiddingStrategy.Search typed flags ---
    (
        "campaigns",
        "add",
        [
            ...
            "add",
            "--name",
            "Test Unified Search AverageCpa",
            "--start-date",
            "2026-06-01",
            "--type",
            "UNIFIED_CAMPAIGN",
    ...
    # --- issue #366: UnifiedCampaign.BiddingStrategy.Network typed flags ---
    (
        "campaigns",
        "add",
        [
            ...
            "add",
            "--name",
            "Test Unified Network AverageCpa",
            "--start-date",
            "2026-06-01",
            "--type",
            "UNIFIED_CAMPAIGN",
