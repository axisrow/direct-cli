...
DRY_RUN_PAYLOAD_EXCLUSIONS = {
    ...
    "agencyclients.update": "Covered by command-level dry-run tests; imported generalclients update fields need a separate public-contract redesign.",
    "clients.update": "Covered by command-level dry-run tests; imported generalclients update fields need a separate public-contract redesign.",
